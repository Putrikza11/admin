...
if (isset($_POST["submit"])) {
    ...
    $harga = $_POST["hargaWarna"];

    // query insert data
    $query = ("INSERT INTO warna (jenis_warna,harga) 
    VALUES ('$jenis_warna','$harga')");
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-9">
                <div class="p-5">
                  <div>
                    <h1 class="h4 text-gray-900 mb-4">Silahkan tambah data baru</h1>
                  </div>
                  <form method="POST">
                    <div class="col-9">
                      <div class="mb-3">
                      ...
                      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-primary me-md-2" type="submit" name="submit">Simpan</button>
                      </div>
                    </div>
