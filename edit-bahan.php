          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-9">
                <div class="p-5">
                  <div>
                    <h1 class="h4 text-gray-900 mb-4">Silahkan Ubah Data Bahan</h1>
                  </div>

                  <?php

                  $result = mysqli_query($conn, "SELECT * FROM bahan WHERE id='$_GET[id]' ");
                  $i = 1;
                  ...
                  <form method="POST">
                    ...
                    <div class="col-9">
                      <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">Nama Bahan</label>
                        <input type="text" class="form-control" name="namaBahan" id="formGroupExampleInput"
                          value="<?= $row['nama_bahan']; ?>">
                      </div>
                      <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">Harga</label>
                        <input type="text" class="form-control" name="hargaBahan" id="formGroupExampleInput2"
                          value="<?= $row['harga']; ?>">
                      </div>
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $harga_bahan = $_POST['hargaBahan'];

                    $conn->query("UPDATE bahan SET nama_bahan = '$nama_bahan', harga='$harga_bahan'
            WHERE id = '$id_bahan' ");
                    echo "
        <script>
            alert('data bahan berrhasil diupdate');
            document.location.href = 'data-produksi.php'
        </script>
    ";
                    // mysqli_query($conn, $query);
                  }
                  // header("Location:../index.php?status='success'&message='Data Bahan berhasil diubah'");
