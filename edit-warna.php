          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-9">
                <div class="p-5">
                  <div>
                    <h1 class="h4 text-gray-900 mb-4">Silahkan Ubah Data Warna</h1>
                  </div>

                  <?php

                  $result = mysqli_query($conn, "SELECT * FROM warna WHERE id='$_GET[id]' ");
                  $i = 1;
                  ...
                  <form method="POST">
                    ...
                    <div class="col-9">
                      <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">Jenis warna</label>
                        <input type="text" class="form-control" name="jenisWarna" id="formGroupExampleInput"
                          value="<?= $row['jenis_warna']; ?>">
                      </div>
                      <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">Harga</label>
                        <input type="text" class="form-control" name="hargaWarna" id="formGroupExampleInput2"
                          value="<?= $row['harga']; ?>">
                      </div>
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $harga_warna = $_POST['hargaWarna'];

                    $conn->query("UPDATE warna SET jenis_warna = '$jenis_warna', harga='$harga_warna'
            WHERE id = '$id_warna' ");
                    echo "
        <script>
            alert('data warna berrhasil diupdate');
