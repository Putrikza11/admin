...
if (isset($_POST["submit"])) {
    ...
    $laminasi = $_POST["jenisLaminasi"];
    $harga_laminasi = $_POST["hargaLaminasi"];

    // query insert data
    $query = ("INSERT INTO laminasi (jenis_laminasi,harga) 
  VALUES ('$laminasi','$harga_laminasi')
  ");
                  ...
                  <form method="POST">
                    <div class="col-9">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="jenisLaminasi" id="formGroupExampleInput">
                      </div>
                      <div class="mb-3">
